...
export function PlayerCard({ player }: { player: IPlayer }) {
  ...
  return (
    <div
      className={`relative overflow-hidden bg-linear-to-b ${className} from-red-500 to-red-700 shadow-lg p-6 flex flex-col justify-between`}
    >
      <div className="z-10">
      ...
      <div className="mt-6 grid grid-cols-2 gap-y-1 text-sm text-gray-200 z-10">
        <p>
          Matches:{" "}
