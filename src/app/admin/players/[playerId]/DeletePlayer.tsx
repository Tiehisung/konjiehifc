...
export default function DeletePlayer({
  ...
  return (
    <div
      id="delete-player"
      className="_secondaryBg rounded-xl p-4 shadow-md max-w-md grow"
    >
      <h1 className="font-light text-lg text-primaryRed ">Delete {name}</h1>
      <form
        onSubmit={handleSubmit}
        className=" space-y-6 border _borderColor rounded-xl h-fit p-4 pt-0"
      >
