    ...
    <section className="w-full py-16 px-6 bg-card rounded-2xl shadow-lg">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-semibold mb-4">
          Partner & Sponsor Konjiehi FC
        </h2>
        <p className="text-lg opacity-90 mb-8">
          We are committed to developing young football talent in the community
          of Konjiehi. By sponsoring our club, you help provide training,
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-10">
          ...
          <div className="p-6 bg-background/20 rounded-xl backdrop-blur-md border border-border/20">
            ...
            <p className="_p">
              Sponsoring Konjiehi FC empowers youth and supports local
              development.
            </p>
          </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
          ...
          >
            <a href="mailto:konjiehifc@gmail.com?subject=Sponsorship%20Inquiry">
              Become a Sponsor
            </a>
          </Button>
          ...
          >
            <a href="tel:+233559708485">Call Us</a>
          </Button>
        </div>
